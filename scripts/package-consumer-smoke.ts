...
const createConsumer = async (
  ...
  if (typecheck) {
    const imports = [
      ...
      'const recordInput = { email: "jane@example.com" } as const;',
      "const protectedRecord: ProtectedValue<typeof recordInput> = redactValue(recordInput);",
      "const recordInputBranch: Extends<typeof recordInput, typeof protectedRecord> = true;",
      "const recordProjectionBranch: Extends<{ readonly email?: string }, typeof protectedRecord> = true;",
      'const broadFunction: Function = () => "jane@example.com";',
      "const protectedFunction = redactValue(broadFunction);",
      "const functionBranch: Extends<Function, typeof protectedFunction> = true;",
      "const functionIsGuaranteed: Extends<typeof protectedFunction, Function> = false;",
      ...
      "void textType;",
      "void recordInputBranch;",
      "void recordProjectionBranch;",
      "void functionBranch;",
      "void functionIsGuaranteed;",
      "void tupleBranch;",
