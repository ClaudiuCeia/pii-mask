...
const createConsumer = async (
  ...
  if (typecheck) {
    const imports = [
      ...
      "type Projected<Shape> = Shape & { constructor?: never; hasOwnProperty?: never; isPrototypeOf?: never; propertyIsEnumerable?: never; toLocaleString?: never; toString?: never; valueOf?: never };",
